...
public interface AdminCommentMapper {
    ...
    @Select("select c.comment_id as id,c.material_id as materialId, m.title, c.content, c.comment_time, c.user_id from comments c join materials m on m.material_id = c.material_id where c.state=0 order by comment_time")
